...
export const content: Translation<HomeTranslation> = {
  en: {
    intro: `Master in Software Engineering (PUC-MG) and Bachelor in Computer Science (PUC-MG), based in Poços de Caldas, Minas Gerais, Brazil. I've been working for more than ${yearsOfExperience} years building web applications, iOS/Android apps, landing pages, custom systems, process automations and AI integrations, with experience in React, React Native, NodeJs, Python, MongoDB and other technologies. I am currently a Sr. Software Engineer at Deel.`,
  ...
  pt: {
    intro: `Mestre em Engenharia de Software (PUC-MG) e Bacharel em Ciência da Computação (PUC-MG), em Poços de Caldas, Minas Gerais, Brasil. Trabalho há mais de ${yearsOfExperience} anos desenvolvendo aplicações web, apps iOS/Android, landing pages, sistemas personalizados, automações de processos e integrações com Inteligência Artificial, com experiência em React, React Native, NodeJs, Python, MongoDB e outras tecnologias. Atualmente sou Sr. Engenheiro de Software na Deel.`,
