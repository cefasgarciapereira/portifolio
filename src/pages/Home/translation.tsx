...
export const content: Translation<HomeTranslation> = {
    ...
    pt: {
        intro: "Mestre em Engenharia de Software (PUC-MG) e Bacharel em Ciência da Computação (PUC-MG). Trabalho a mais de 6 anos em processos e desenvolvimento de aplicações web, apps iOS/Android, prototipação, UI/UX com experiência em React, React Native, NodeJs, Python, MongoDB, AEM etc. Atualmente sou Analista de Sistemas na CI&T.",
        role: "Fullstack Developer",
